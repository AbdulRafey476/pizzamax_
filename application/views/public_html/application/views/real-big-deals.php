...
<section class="pmax-deals-card pattern-bg section-padtop-50 section-padbottom-30">
	<div class="container tab-width">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="pmax-h1 pmax-red text-uppercase text-center pmax-extra-bold lh-min mb-5">Real Big<br><span class="pmax-h4 pmax-grey">Deals</span></h1>
			</div>
		</div>
		<div class="row">
			<div class="col-md-9">
				<div class="row">
					...
					<?php foreach ($real_big_deals as $item) : ?>
