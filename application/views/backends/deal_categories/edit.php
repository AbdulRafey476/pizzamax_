...
<section class="content-header">
  <h1>
	<?php echo lang('msg_deal_categories'); ?>
	<small><?php echo lang('msg_edit_deal_categories'); ?></small>
  </h1>
  <ol class="breadcrumb">
	<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="#"><?php echo lang('msg_dashboard'); ?></a></li>
	<li><a href="#"><?php echo lang('msg_deal_categories'); ?></a></li>
	<li class="active"><?php echo lang('msg_edit_deal_categories'); ?></li>
...
<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"><?php echo lang('msg_edit_deal_categories'); ?></h3>
        </div>
	...
	;?>
	<form class="form-horizontal" id="form" method="post" enctype="multipart/form-data" action="<?php echo base_url().'admin/deal_categories/edit_post';?>">
