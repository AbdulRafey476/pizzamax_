...
class Home extends MY_Controller
{
	...
	public function get_foods()
	{
		...
		// 		$data['cat']['foods'] = $this->categories_model->get('*');
		// 		$data['deals'] = $this->deals_model->get('*', ['is_active' =>1]);
		$data['foods'] = $this->food_model->get('foods.id as id,foods.name,foods.description,foods.price,foods.image,foods.featured,foods.only_for_promo,foods.categories_id,categories.name as cat_name,foods.name as name,foods.image as path');
