...
class Users extends MY_Controller
{
	...
	function index()
	{
		...
		$data['customers_list'] = $this->users_model->get("*", array('role_id' => 4), array(), $first, $this->pg_per_page, array('id' => 'DESC'));
		$data['other_list'] = $this->users_model->get("*", array('role_id !=' => 4), array(), $first, $this->pg_per_page, array('id' => 'DESC'));
	...
	public function create()
	{
		...
		if (isset($_POST['user_name'])) {
			...
			if ($this->form_validation->run() != false) {
				...
				$data['role_id'] = $this->input->post('perm');
