...
class orders_model extends CI_Model
{
    ...
    public function get($select = "*", $array_where = false, $array_like = false, $first = false, $offset = false, $order_by = false)
    {
        $data = array();
        if ($order_by != false) {
            $order = key($order_by);
    ...
    public function get_by_exact_name($name)
    {
        $select = '*';
        $array_like = array();
    ...
    public function get_by_name($name, $first, $offset)
    {
        $select = '*';
        $array_where = array();
        $array_like = array('full_name' => $name);
        $order_by = array();
        return $this->get($select, $array_where, $array_like, $first, $offset, $order_by);
    }

    public function get_by_id_and_name($id, $name, $first, $offset)
    {
        $select = '*';
        $array_where = array();
	...
	public function status_update_order($data_array, $array_where)
    {
        $this->db->where($array_where);
        $this->db->update('orders', $data_array);
    }
